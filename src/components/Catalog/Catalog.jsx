            ...
            <ul className="catalog__list">
              <li className="catalog__item">
                <article className="product">
                  <img src="../../src/assets/img/photo-5.jpg" alt="Мясная бомба" className="product__image" />
              ...
              <li className="catalog__item">
                <article className="product">
                  <img src="../../src/assets/img/photo-1.jpg" alt="Супер сырный" className="product__image" />
              ...
              <li className="catalog__item">
                <article className="product">
                  <img src="../../src/assets/img/photo-3.jpg" alt="Сытный" className="product__image" />
              ...
              <li className="catalog__item">
                <article className="product">
                  <img src="../../src/assets/img/photo.jpg" alt="Тяжелый удар" className="product__image" />
              ...
              <li className="catalog__item">
                <article className="product">
                  <img src="../../src/assets/img/photo-2.jpg" alt="Вечная классика" className="product__image" />
              ...
              <li className="catalog__item">
                <article className="product">
                  <img src="../../src/assets/img/photo-4.jpg" alt="Итальянский" className="product__image" />
