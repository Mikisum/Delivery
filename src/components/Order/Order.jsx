        ...
        <div className="order__wrap_list">
          <ul className="order__list">
            <li className="order__item">
              <img className="order__image" src="../../src/assets/img/burger_1.jpg" alt="Супер сырный" />
            ...
            <li className="order__item">
              <img className="order__image" src="../../src/assets/img/free_1.jpg" alt="Картошка фри" />
            ...
            <li className="order__item">
              <img className="order__image" src="../../src/assets/img/hot-dog_1.jpg" alt="Жгучий хот-дог" />
